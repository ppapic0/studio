...
export const UNIVERSITY_THEMES: Record<SupportedUniversityThemeKey, UniversityThemeDefinition> = {
  ...
  sungkyunkwan: {
    ...
    accent: '#78BE20',
    accentSoft: '#CBE7A0',
    sourceUrl: 'https://www.skku.edu/skku/about/symbol/colors.do',
  ...
  hanyang: {
    ...
    accent: '#5E94C4',
    accentSoft: '#B1CCE5',
    sourceUrl: 'https://www.hanyang.ac.kr/web/www/symbol-color',
  ...
  'seoul-city': {
    ...
    accent: '#C77995',
    accentSoft: '#E8BDCB',
    sourceUrl: 'https://www.uos.ac.kr/kor/html/symbol/symbol_color.do',
  ...
  kookmin: {
    ...
    accent: '#B9788C',
    accentSoft: '#DDB5C0',
    sourceUrl: 'https://www.kookmin.ac.kr/user/kmuNews/notice/52/4714874',
  ...
  sejong: {
    ...
    accent: '#D67D8E',
    accentSoft: '#EDC1C9',
    sourceUrl: 'http://www.sejong.ac.kr/unilife/symbol.html',
