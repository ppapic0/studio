...
// Source URLs point to official university brand / UI / symbol pages and downloadable assets verified on 2026-04-15.
// When a school publishes or ships exact RGB values, the primary/accent colors below use those official values.
...
export const UNIVERSITY_THEMES: Record<SupportedUniversityThemeKey, UniversityThemeDefinition> = {
  ...
  sungkyunkwan: {
    ...
    accent: '#8DC63F',
    accentSoft: '#C8E697',
    sourceUrl: 'https://www.skku.edu/skku/about/symbol/symbol_01.do',
  ...
  hufs: {
    ...
    accent: '#8D7150',
    accentSoft: '#DADAD3',
    sourceUrl: 'https://www.hufs.ac.kr/hufs/11129/subview.do',
  ...
  konkuk: {
    ...
    accent: '#00AC54',
    accentSoft: '#DCECE4',
    sourceUrl: 'https://www.konkuk.ac.kr/bbs/konkuk/4220/1156969/artclView.do',
  ...
  dankook: {
    ...
    accent: '#6B9CD5',
    accentSoft: '#B5D0EE',
    sourceUrl: 'https://www.dankook.ac.kr/web/international/symbols',
