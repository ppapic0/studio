...
export const STUDENT_MANUAL_RULE_SECTIONS: StudentManualRuleSection[] = [
  ...
  },
  {
    ...
    eyebrow: 'LIFE',
    title: '생활 및 위생 규정',
    description: '공용 공간을 함께 쓰는 만큼 복장, 음식물, 자리 위생까지 깐깐하게 관리합니다.',
    tone: 'emerald',
    items: [
      '개인 자리와 공용 공간은 항상 깨끗하게 유지해요.',
      '자습실 안에서는 반드시 실내화를 착용해요. 양말·맨발·외부 신발은 금지예요.',
      '자습실 안에서는 물 외 음식물 섭취가 금지예요. 젤리, 사탕, 껌, 초콜릿, 과자도 모두 금지예요.',
...
export const STUDENT_PENALTY_GUIDE_ITEMS: StudentPenaltyGuideItem[] = [
  {
    key: 'late-absence',
    title: '지각·결석·무단이탈',
    description: '지각은 자동 반영, 무단 결석·외출·이석은 사유와 관계없이 즉시 누적돼요.',
    pointsLabel: '+1~3점',
  ...
  {
    key: 'device',
    title: '휴대폰·태블릿·와이파이 위반',
    description: '휴대폰 미반납, 비학습 앱·영상, 방화벽 우회는 중대 위반으로 강하게 반영돼요.',
    pointsLabel: '+2~5점',
  ...
  },
  {
    key: 'focus',
    title: '학습 분위기 저해',
    description: '잡담, 소음, 장난, 무단이석, 반복 이동은 즉시 제지하고 누적 관리해요.',
    pointsLabel: '+1~4점',
  ...
  },
  {
    key: 'indoor-shoes',
    title: '자습실 실내화 미착용',
    description: '자습실 안에서는 실내화가 필수예요. 외부 신발, 맨발, 양말 착석은 허용하지 않아요.',
    pointsLabel: '+1~2점',
    tone: 'border-sky-100 bg-sky-50/70 text-sky-700',
  },
  {
    key: 'food',
    title: '자습실 음식물 섭취 금지',
    description: '물 외 음식물은 전부 금지예요. 젤리, 사탕, 껌, 초콜릿, 과자도 예외 없이 반영돼요.',
    pointsLabel: '+2~5점',
    tone: 'border-rose-100 bg-rose-50/70 text-rose-600',
  },
  {
    key: 'facility',
    title: '위생·시설 규정 위반',
    description: '쓰레기 방치, 자리 오염, 시설 훼손, 냄새 유발은 반복 전이라도 바로 반영돼요.',
    pointsLabel: '+1~5점',
...
export const STUDENT_MANUAL_PENALTY_RULE_ROWS: StudentPenaltyRuleRow[] = [
  {
    ...
    detail: '승인된 지각도 출결 기준상 자동 반영됩니다. 반복 지각은 상담·보호자 안내로 이어져요.',
    tone: 'amber',
  },
  {
    key: 'absence',
    ...
    pointsLabel: '+2~3점',
    detail: '사전 승인 없이 자리, 층, 센터를 이탈하면 즉시 누적됩니다. 사후 보고는 면제 사유가 아니에요.',
    tone: 'rose',
  },
  {
    key: 'routine',
    category: '루틴 미작성',
    pointsLabel: `+${ROUTINE_MISSING_PENALTY_POINTS}점`,
    detail: '등원 전 루틴을 쓰지 않으면 자동 기록됩니다. 당일 뒤늦게 작성해도 원칙상 벌점 대상이에요.',
    tone: 'navy',
  },
  {
    key: 'phone',
    ...
    pointsLabel: '+2~4점',
    detail: '입실 즉시 전원 OFF 후 반납이 원칙입니다. 가방 보관, 몰래 사용, 알림 확인도 위반이에요.',
    tone: 'rose',
  },
  {
    key: 'noise',
    ...
    pointsLabel: '+1~3점',
    detail: '속삭임, 장난, 반복 이동, 의자 소음처럼 집중을 깨는 행동은 선생님이 바로 반영할 수 있어요.',
    tone: 'orange',
  },
  {
    key: 'tablet',
    ...
    pointsLabel: '+3~5점',
    detail: '인강·문서·문제풀이 외 사용은 금지입니다. 게임, SNS, 쇼츠, 웹툰, 비학습 영상은 중대 위반이에요.',
    tone: 'amber',
  },
  {
    key: 'firewall',
    ...
    pointsLabel: '+5점',
    detail: 'VPN, 테더링, 프록시, 우회 앱 사용은 중대 위반입니다. 보호자 안내와 기기 제한이 함께 진행될 수 있어요.',
    tone: 'rose',
  },
  {
    key: 'earphone',
    ...
    pointsLabel: '+1~2점',
    detail: '인강은 반드시 이어폰으로만 들어요. 소리 유출, 통화, 녹음 재생은 주변 집중을 해치는 위반이에요.',
    tone: 'navy',
  },
  {
    key: 'indoor-shoes',
    category: '자습실 실내화 미착용',
    pointsLabel: '+1~2점',
    detail: '자습실 내부는 실내화 착용이 필수입니다. 외부 신발, 맨발, 양말 착석은 예외 없이 벌점 대상이에요.',
    tone: 'amber',
  },
  {
    key: 'food',
    category: '자습실 내 음식물·간식 섭취',
    pointsLabel: '+2~5점',
    detail: '자습실 안에서는 먹는 행위가 전부 금지입니다. 젤리, 사탕, 껌, 초콜릿, 과자도 모두 벌점 대상이에요.',
    tone: 'rose',
  },
  {
    key: 'food-sharing',
    category: '음식물 반입·보관·나눠먹기',
    pointsLabel: '+1~3점',
    detail: '먹지 않았더라도 자습실 안에 간식을 올려두거나 나눠주는 행동은 분위기 저해로 처리돼요.',
    tone: 'orange',
  },
  {
    key: 'clean',
    category: '자리 정리 미흡·쓰레기·냄새 유발',
    pointsLabel: '+1~2점',
    detail: '책상 오염, 쓰레기 방치, 냄새 유발 물품은 즉시 정리 대상이며 반복 전이라도 누적될 수 있어요.',
    tone: 'emerald',
  },
  {
    key: 'damage',
    ...
    pointsLabel: '+5점',
    detail: '책상, 의자, 벽면, 콘센트, 사물함 훼손은 배상 책임과 보호자 안내가 바로 들어갑니다.',
    tone: 'rose',
  },
  {
    key: 'harm',
    ...
    pointsLabel: '즉시 조치',
    detail: '고의 은폐, 반항, 타인 피해, 반복 위반은 누적 점수와 무관하게 귀가·퇴원 검토가 가능합니다.',
    tone: 'rose',
  },
];
...
export const STUDENT_MANUAL_PRO_TIPS = [
  ...
  '자습실 안에서는 실내화를 반드시 착용하고, 젤리·사탕 같은 작은 간식도 절대 먹지 마세요.',
