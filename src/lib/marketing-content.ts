...
export const marketingContent: MarketingContent = {
  ...
  centerEnvironment: {
    ...
    description:
      '실제 센터 분위기와 좌석 구성을 먼저 읽을 수 있도록 전경 사진 1장과 좌석별 소개 2장을 정리해두었습니다. 추후 실제 스터디센터 사진으로 바로 교체할 수 있게 구성했습니다.',
    highlights: ['센터 전경', '러셀형 좌석', '집중형 좌석'],
    photos: [
      {
        title: '트랙 전경',
        summary: '센터 전체 분위기와 동선을 먼저 보여주는 대표 전경 영역입니다. 실제 스터디센터 사진으로 교체하면 첫인상이 바로 살아나도록 잡아두었습니다.',
        alt: '트랙 전경 실제 사진 예정 자리',
      },
      {
        title: '러셀형 좌석',
        summary: '개인 시야를 정리해 혼자 깊게 몰입하기 좋은 좌석입니다. 칸막이감과 착석 시 집중 포인트를 사진과 함께 소개할 수 있게 구성했습니다.',
        alt: '러셀형 좌석 실제 사진 예정 자리',
      },
      {
        title: '집중형 좌석',
        summary: '정면 집중과 빠른 착석 흐름이 필요한 학생에게 맞는 좌석입니다. 실제 배치 사진을 넣으면 공간감과 운영 톤이 자연스럽게 전달됩니다.',
        alt: '집중형 좌석 실제 사진 예정 자리',
      },
    ],
  },
  mockExamProgram: {
