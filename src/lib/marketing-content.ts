...
const webAppShowcaseScreens: WebAppShowcaseScreen[] = experienceShowcaseSections.map((section) => ({
  mode: section.mode,
  title: section.title,
  summary: section.summary,
  highlights: section.highlights,
  image: section.primaryScreen.image,
  alt: section.primaryScreen.alt,
}));
...
export const marketingContent: MarketingContent = {
  ...
  centerEnvironment: {
    eyebrow: 'TRACK VIEW',
    title: '트랙 전경과 좌석 구성을 먼저 확인해보세요',
    description:
      '실제 센터 분위기와 좌석 구성을 한 번에 읽을 수 있도록 전경 사진과 좌석 타입별 사진을 함께 정리했습니다. 방문 전 공간의 분위기와 좌석 선택 감각을 먼저 확인할 수 있습니다.',
    highlights: ['센터 전경', '러셀형 좌석', '집중형 좌석'],
    photos: [
      {
        title: '트랙 전경',
        summary: '러셀형 좌석과 집중형 좌석이 함께 보이는 실제 센터 전경입니다. 전체적인 동선과 공간 톤을 먼저 확인할 수 있도록 대표 사진으로 배치했습니다.',
        image: '/marketing/track-view/track-overview.jpg',
        alt: '트랙 관리형 스터디센터 전경과 좌석 배치',
      },
      {
        title: '러셀형 좌석',
        summary: '가운데 긴 테이블 구조로 운영되는 러셀형 좌석입니다. 넓은 상판과 정돈된 배치로 여러 학생이 안정적으로 같은 흐름에서 공부하기 좋습니다.',
        image: '/marketing/track-view/russell-seat.jpg',
        alt: '트랙 스터디센터 러셀형 긴 테이블 좌석',
      },
      {
        title: '집중형 좌석',
        summary: '1인 칸막이 구조로 시야를 차분하게 정리해 주는 집중형 좌석입니다. 개인 몰입이 필요한 학생이 안정적으로 루틴을 유지하기 좋은 자리입니다.',
        image: '/marketing/track-view/focus-seat.jpg',
        alt: '트랙 스터디센터 집중형 1인 칸막이 좌석',
      },
    ],
  },
  mockExamProgram: {
  ...
  consult: {
    ...
    hoursLine: '학기중 평일 오후 5:00 ~ 다음날 오전 1:00 <br> 학기중 토요일·일요일·공휴일 오전 8:00 ~ 다음날 오전 1:00 <br> 방학중 오전 8:00 ~ 다음날 오전 1:00 <br> N수생 별도 운영시간 운영',
  },
  footer: {
    ...
    hours: '운영 시간: 학기중 평일 오후 5:00 ~ 다음날 오전 1:00 <br> 학기중 토요일·일요일·공휴일 오전 8:00 ~ 다음날 오전 1:00 <br> 방학중 오전 8:00 ~ 다음날 오전 1:00 <br> N수생 별도 운영시간 운영',
  },
};
