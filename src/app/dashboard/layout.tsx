...
export default function DashboardLayout({
  ...
  return (
    <div className={cn(
      ...
      isForcedMobile ? "flex flex-col items-center bg-[#c8c8c8] py-6 sm:py-12" : "grid md:grid-cols-[240px_1fr] lg:grid-cols-[280px_1fr]"
    )}>
      ...
      <div className={cn(
        ...
        isForcedMobile 
          ? "w-[390px] h-[844px] bg-background rounded-[3.5rem] overflow-hidden border-[12px] border-[#121212] shadow-[0_60px_120px_-30px_rgba(0,0,0,0.5)] ring-1 ring-black/20" 
          : "w-full min-h-screen"
      )}>
        ...
        <main className={cn(
          ...
          isForcedMobile ? "p-5 pb-28 pt-2" : "p-6 md:p-8 lg:p-12 max-w-[1500px] pb-32 md:pb-12"
        )}>
          {children}
        </main>
        ...
        {isForcedMobile && (
          <div className="absolute bottom-1.5 left-1/2 -translate-x-1/2 w-32 h-1.5 bg-black/10 rounded-full z-[60]" />
        )}
      </div>
    </div>
  );
