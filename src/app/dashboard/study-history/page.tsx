              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isMobile ? "aspect-square min-h-[4.15rem] p-1" : "min-h-[150px] p-3",
                ...
                >
                  ...
                  <div className={cn("relative z-10 flex h-full flex-col", isMobile ? "gap-1" : "gap-2")}>
                    <div className="flex items-start justify-between gap-1.5">
                      ...
                      {isMobile ? (
                        hasDeepFocus ? (
                          <span className="inline-flex h-5 w-5 items-center justify-center rounded-full border border-amber-100 bg-white/95 text-amber-500 shadow-[0_8px_16px_-14px_rgba(15,23,42,0.24)]">
                            <Zap className="h-2.5 w-2.5 fill-amber-500" />
                          </span>
                        ) : hasPlans ? (
                          <span className="mt-1 inline-flex h-2.5 w-2.5 rounded-full bg-primary shadow-[0_6px_12px_-10px_rgba(37,99,235,0.45)]" />
                        ) : (
