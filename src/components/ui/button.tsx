...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold tracking-[-0.015em] ring-offset-background transition-[transform,filter,background-color,border-color,opacity] duration-100 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-45 active:scale-[0.97] active:brightness-[0.93] will-change-transform select-none",
  {
    variants: {
      variant: {
        default:
          "bg-[#14295F] text-white border border-[#0c1e4a] hover:bg-[#1a3570] shadow-sm",
        destructive:
