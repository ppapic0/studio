  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-11 w-full rounded-xl border bg-[var(--surface-light-gradient)] px-3.5 py-2.5 text-[14px] font-medium text-[var(--text-primary)] ring-offset-background transition-[border-color,box-shadow,background-color] duration-150 ease-out",
