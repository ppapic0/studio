    ...
    <DialogPrimitive.Overlay
      ...
      className={cn(
        resolvedMotionPreset === "dashboard-premium"
          ? "dashboard-premium-overlay fixed inset-0 z-50 data-[state=closed]:pointer-events-none"
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          resolvedMotionPreset === "dashboard-premium"
            ? "dashboard-premium-dialog fixed left-[50%] top-[50%] z-50 grid w-[calc(100vw-1rem)] max-h-[calc(100dvh-1rem)] max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-auto overscroll-contain border border-[color:var(--border-subtle)] bg-[var(--bg-surface-1)] p-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] text-[var(--text-primary)] shadow-[var(--shadow-card-strong)] data-[state=closed]:pointer-events-none sm:w-full sm:rounded-[1.5rem]"
            : "fixed left-[50%] top-[50%] z-50 grid w-[calc(100vw-1rem)] max-h-[calc(100dvh-1rem)] max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-auto overscroll-contain border border-[color:var(--border-subtle)] bg-[var(--bg-surface-1)] p-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] text-[var(--text-primary)] shadow-[var(--shadow-card-strong)] duration-200 data-[state=closed]:pointer-events-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:w-full sm:rounded-[1.25rem]",
          className
        )}
        {...props}
      >
