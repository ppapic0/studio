...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-[3px] text-[11.5px] font-bold tracking-[-0.01em] transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-[#1a3570] bg-[linear-gradient(180deg,#1e4898,#14295f)] text-white shadow-[0_1px_0_rgba(255,255,255,0.18)_inset,0_2px_6px_rgba(20,41,95,0.22)]",
        secondary:
