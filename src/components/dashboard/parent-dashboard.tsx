        ...
        <CardContent className={cn('p-6 space-y-6')}>
          ...
          <Tabs value={tab} onValueChange={handleTabChange} className="w-full">
            <TabsContent value="home" className="mt-0 space-y-6 animate-in fade-in duration-500">
              <div className="grid grid-cols-3 gap-3">
                ...
                <Card className={cn(
                  ...
                  <p className="text-xl font-black leading-tight truncate">{attendanceStatus.label.split(' ')[0]}</p>
                </Card>
              </div>
              ...
              <Card className="rounded-[2rem] border-none bg-slate-50 p-6 ring-1 ring-slate-100 relative overflow-hidden group">
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-[10px] font-black text-[#14295F] uppercase tracking-widest">어제의 정밀 분석 결과</span>
                </div>
            ...
            <TabsContent value="studyDetail" className="mt-0 space-y-4 animate-in fade-in duration-500">
                  ...
                  {subjects.slice(0, 4).map((s, i) => (
                    <div key={s.subject} className="flex flex-col gap-2">
                      <div className="flex justify-between items-center text-xs font-bold text-slate-700">
                        ...
                        <span className="font-black text-[#14295F]">{s.minutes}분</span>
                      </div>
              ...
              <Dialog>
                <DialogTrigger asChild>
                  <Button variant="ghost" className="w-full h-12 rounded-2xl font-black text-xs text-slate-400 hover:text-[#14295F] transition-all">
