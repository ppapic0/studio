                ...
                <article key={sample.title} className="marketing-card overflow-hidden p-5">
                  <div className="relative h-28 rounded-xl bg-[linear-gradient(145deg,#14295F,#1E418F)] p-4 text-white">
                    ...
                    <div className="relative flex h-full flex-col justify-between">
                      ...
                      <p className="max-w-[12rem] break-keep text-xl font-extrabold leading-[1.15] tracking-[-0.04em]">{sample.title}</p>
                    </div>
                  </div>
                  <p className="mt-2 break-keep text-sm font-medium leading-[1.74] text-slate-600">{sample.caption}</p>
                </article>
              ))}
            </div>
          </div>
