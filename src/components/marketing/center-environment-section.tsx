  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <article className="marketing-card-warm brand-sheen-panel relative overflow-hidden px-5 py-6 sm:px-7 sm:py-8 lg:px-9 lg:py-9">
          ...
          <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-4 break-keep text-[clamp(1.85rem,4vw,2.8rem)] font-black leading-[1.12] text-[#14295F]">
                {centerEnvironment.title}
              </h2>
              <p className="mt-4 break-keep text-[14px] font-semibold leading-[1.84] text-[#425A75] sm:text-[15px]">
            ...
            <div className="marketing-card relative max-w-sm shrink-0 border-[#14295F]/10 bg-white/92 p-4 sm:p-5 lg:w-[21rem]">
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <h3 className="mt-2 break-keep text-[1.1rem] font-black leading-[1.35] text-[#14295F]">
                    {photo.title}
                  </h3>
                </div>
                ...
                <div className="relative aspect-[4/3] overflow-hidden rounded-[1rem] border border-dashed border-[#14295F]/14 bg-white">
                  {photo.image ? (
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-[radial-gradient(circle_at_top,rgba(255,122,22,0.10),transparent_34%),linear-gradient(160deg,#F9FBFF_0%,#FFFFFF_100%)] px-6 text-center">
                      ...
                      <p className="mt-2 break-keep text-[0.98rem] font-black leading-[1.35] text-[#14295F]">
                        실제 센터 사진 예정
                      </p>
              ...
              <p className="mt-4 break-keep text-[13px] font-semibold leading-[1.74] text-[#52667D]">{photo.summary}</p>
            </article>
          ))}
        </div>
      </div>
