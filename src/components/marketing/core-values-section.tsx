        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          {valueCards.map((card) => (
            ...
            >
              ...
              <h3 className="mt-4 break-keep text-[1.45rem] font-extrabold leading-[1.18] tracking-[-0.04em] text-[#14295F]">{card.title}</h3>
              <p className="mt-3 break-keep text-sm font-medium leading-[1.72] text-slate-600">{card.description}</p>
            </article>
          ))}
        </div>
      </div>
