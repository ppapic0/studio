...
export function FocusFirewallSection() {
  return (
        ...
        <div className="border-t border-[#14295F]/8 bg-[linear-gradient(180deg,#F8FBFF_0%,#FFFFFF_100%)] px-6 py-7 sm:px-8 sm:py-8 lg:border-l lg:border-t-0">
          <div className="relative overflow-hidden rounded-[1.9rem] border border-[#D9E7FF] bg-[linear-gradient(180deg,#F9FBFF_0%,#EEF5FF_100%)] p-4 shadow-[0_20px_44px_rgba(20,41,95,0.08)] sm:p-5">
            ...
            <div className="relative">
              <p className="text-[10px] font-black tracking-[0.18em] text-[#14295F]/55">WEB APP CONTROL</p>
              <div className="mt-4 flex min-h-[270px] items-center justify-center rounded-[1.6rem] border border-dashed border-[#14295F]/12 bg-white/82 px-6 py-10 text-center sm:min-h-[320px]">
                <div className="max-w-[220px]">
                  ...
                  <p className="font-aggro-display mt-3 break-keep text-[1.15rem] font-black leading-[1.35] tracking-[-0.03em] text-[#14295F]">허용사이트 설정 화면 예정</p>
