  ...
  return (
    ...
    >
      <div className="grid gap-0 lg:grid-cols-[0.96fr_1.04fr]">
        ...
        <div className={cn('border-t px-6 py-7 sm:px-8 sm:py-8 lg:border-l lg:border-t-0', isDark ? 'border-white/10 bg-white/6' : 'border-[#14295F]/8 bg-[linear-gradient(180deg,#F8FBFF_0%,#FFFFFF_100%)]')}>
          <div className={cn('relative overflow-hidden rounded-[1.9rem] border p-4 shadow-[0_20px_44px_rgba(20,41,95,0.08)] sm:p-5', isDark ? 'border-white/12 bg-[linear-gradient(180deg,rgba(255,255,255,0.10)_0%,rgba(255,255,255,0.04)_100%)]' : 'border-[#D9E7FF] bg-[linear-gradient(180deg,#F9FBFF_0%,#EEF5FF_100%)]')}>
            ...
            <div className="relative">
              <p className={cn('text-[10px] font-black tracking-[0.18em]', isDark ? 'text-white/58' : 'text-[#14295F]/55')}>WEB APP CONTROL</p>
